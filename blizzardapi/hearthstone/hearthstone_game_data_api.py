...
class HearthstoneGameDataApi(Api):
    ...
    def search_cards(self, region, locale, **query_params):
        """
        Cards - Returns an up-to-date list of all cards matching the
        search criteria.
        """
    ...
    def get_card(self, region, locale, id_or_slug, game_mode="constructed"):
        """
        Cards - Returns the card with an ID or slug that matches the
        one you specify.
        """
    ...
    def search_card_backs(self, region, locale, **query_params):
        """
        Card Backs - Returns an up-to-date list of all card backs
    ...
    def get_card_back(self, region, locale, id_or_slug):
        """
        Card Backs - Returns a specific card back by using card back ID
        or slug.
        """
    ...
    def get_deck(self, region, locale, **query_params):
        """
        Decks - Finds a deck by list of cards or code, including the
        hero.
        """
    ...
    def get_metadata(self, region, locale):
        """
        Metadata - Returns information about the categorization of
        cards.
        """
