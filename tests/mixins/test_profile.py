...
class TestProfileMixin(object):
    ...
    def test_get_account_collections_index(self, response_mock):
    ...
    def test_get_account_mounts_collection_summary(self, response_mock):
    ...
    def test_get_account_pets_collection_summary(self, response_mock):
    ...
    def test_get_character_achievement_statistics(self, response_mock):
    ...
    def test_get_character_collections_index(self, response_mock):
    ...
    def test_get_character_mounts_collection_index(self, response_mock):
    ...
    def test_get_character_pets_collection_index(self, response_mock):
    ...
    def test_get_character_mythic_keystone_profile_index(self, response_mock):
    ...
    def test_get_character_mythic_keystone_profile_season_details(self, response_mock):
    ...
    def test_get_character_pvp_bracket_statistics(self, response_mock):
    ...
    def test_get_character_statistics_summary(self, response_mock):
